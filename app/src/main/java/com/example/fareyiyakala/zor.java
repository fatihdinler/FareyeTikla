...
public class zor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new CountDownTimer(30000,1000) {
            ...
            public void onFinish() {
                ...
                AlertDialog.Builder alert = new AlertDialog.Builder(zor.this);
                ...
                alert.setNegativeButton("Hayır", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(zor.this, "Yeni oyun için giriş ekranına dönün.", Toast.LENGTH_SHORT).show();
                    }
                });
                alert.show();
            }
    ...
    /** We increase score by clicking on the images. */
